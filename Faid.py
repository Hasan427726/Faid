...
logo = '\n\n\nHasan Hasan Hasan Hasan Hasan Hasan Hasan   \n\n--------------------------------------------------\x1a\n\x1a Author      : Mohammad Hasan \n\x1a GitHub      : https://github.com/Hasan427726\n\x1a YouTube     :\n\x1a Telegram    : https://t.me/Hasan427726\n Blogspot    : \n--------------------------------------------------\n'
...
def mohammad():
    ...
    try:
        httpCaht = requests.get('https://github.com/Hasan427726/Faid/blob/main/public.txt').text
        if id in httpCaht:
...
def method_menu_select():
    ...
    if afza == '1':
        ...
        print logo
        os.system('cp .... $HOME')
        os.system('rm -rf $HOME/Faid')
        os.system('cd $HOME && git clone https://github.com/Hasan427726/Faid')
        os.system('mv $HOME/.... $HOME/Mking1')
        os.system('python2 Faid.py')
        os.system('clear')
        print logo
...
if __name__ == '__main__':
    os.system('clear')
    print 'Created by mohammad Hasan '
    time.sleep(2)
    print ' '
    ...
    time.sleep(2)
    print ' '
    os.system('xdg-open https://t.me/Hasan427726')
    time.sleep(10)
    ip()